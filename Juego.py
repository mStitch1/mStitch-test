...
def tablero(tabla_map, player = 0, fila = 0, columna = 0, just_display = False):
	try:
...
while jugar:
	tamaño = int(input("De qué tamaño quieres que sea el juego?: "))
	tabla = [[0 for i in range(tamaño)] for i in range(tamaño)]  
	print(tabla)
